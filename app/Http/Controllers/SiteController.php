...
class SiteController extends Controller
{
    public function aboutUs()
    {
        ...
        return view('backend.site_settings.about_us.edit', compact('data'));
    }
    ...
    public function contactUs()
    {
        ...
        return view('backend.site_settings.contact_us.edit', compact('data', 'addresses'));
    }
    ...
    {
        return view('backend.site_settings.contact_us.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.site_settings.contact_us.c_edit', compact('data'));
    }
    ...
    public function othersIndex()
    {
        ...
        return view('backend.site_settings.others.index', compact('pages'));
    }

    public function othersCreate(){
        return view('backend.site_settings.others.create');
    }
    public function Otheredit(OtherPages $data){
    return view('backend.site_settings.others.edit' , compact('data'));
    }
