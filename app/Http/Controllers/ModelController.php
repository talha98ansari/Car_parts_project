...
class ModelController extends Controller
{
    ...
    {
        $models = CarModel::get();
        return view('backend.carmodel.index', compact('models'));
    }
...
/**
    ...
    {
        $makers = Maker::get();
        return view('backend.carmodel.create', compact('makers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.carmodel.edit', compact('data' , 'makers'));
    }
