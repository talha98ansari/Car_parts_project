        ...
        <span>
            ...
            <a class="btn text-white rounded-circle btn-sm1 mx-3 "
                ...
                role="button"><span style="color: #FF4E00; font-size: 15px;"><i id="ic" class="fa-regular fa-heart"
                        onclick="changeToImage()"></i></span></a>
                    ...
                    <div class="d-flex mt-5 ms-5">
                        <nav class="glasses">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <p class="nav1 d-grid text-center"> <button class="border1 mx-2 nav-link active"
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="container p-0">
                    <img data-bs-dismiss="modal" aria-label="Close" type="button"
                        src="{{asset('front/ages/icons/greater.png')}}" alt=""
                        class="mt-4 m-2 position-absolute start-0 top-0">
                    <div class="row text-dark mb-3">
                        <div class="col-md-7 mt-5">
                            <img src="{{asset('front/images/1161014-sunglasses-front-view 1.png')}}" alt=""
                                class="img-fluid" id="glasses">
                        ...
                        <div class="col-md-5 table2 p-4">
                            <a href="#" class="scan">Scan Your Prescription <img
                                    src="{{asset('front/ages/question.png')}}" alt=""></a>
                            <p class="text-center use">Use your camera to take a photo of your written prescription or
                                upload
                                an
                                image.</p>
                            <table class="table tables table-bordered"
                                style="color : #007b8f; border: 2px solid #007b8f;">
    ...
    padding-top: 20px;">O.S.</th>
                            ...
                            <div class="d-flex take">
                                ...
                                <button type="button" class="btn btn4 btn-lg fw-bold w-50 mx-2"
                                    style="border: 1.5px solid #69442E; color: #69442E"> Upload Image <img
                                        src="{{asset('front/ages/pictures.png')}}" alt="" class="pictures"></button>
                            </div>
                            <p class="text-center fst-italic enter text-decoration-underline">Enter your prescription
                                manually
                            </p>
                            ...
                            <div class="container prism bg-light">
                                <p><strong>Have Prism Values?</strong><br>The scan can't capture prism values. Please
                                    enter manually from your prescription if noted.</p>
