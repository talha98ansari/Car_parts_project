        ...
        <div class="container">
            <div class="row align-items-xl-end align-items-center">
                ...
                <div class="col-xl-3 col-md-6 my-3">
                    <img src="{{asset('front/images/club-big.png')}}"" alt="" class="img-fluid w-100">
                    <div class="mt-3">
                ...
                <div class="col-xl-3 col-md-6 my-3">
                    <div class="text-end">
                        <a href="#_">
                            <img src="{{asset('front/images/youtube-logo.png')}}"" alt="" class="mb-2 img-fluid">
                        </a>
                    </div>
                    <img src="{{asset('front/images/youtube-big.png')}}"" alt="" class="img-fluid w-100">
                    <div class="mt-3">
                ...
                <div class="col-xl-3 col-md-6 my-3">
                    <div class="text-end">
                        <a href="#_">
                            <img src="{{asset('front/images/insta-logo.png')}}"" alt="" class="mb-2 img-fluid">
                        </a>
                    </div>
                    <img src="{{asset('front/images/instagram-big.png')}}"" alt="" class="img-fluid w-100">
                    <div class="mt-3">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 my-3">
                    ...
                    <select class="js-example-basic-single w-100" name="state">
                        <option value="AL"><img src="{{asset('front/images/uk-flag.png')}}"" alt="" class="img-fluid"> United Kingdom
                        </option>
                    </select>
                    <div class="mt-4">
